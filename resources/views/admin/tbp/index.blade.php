  ...
  <section class="section">
      ...
      <div class="section-body">
          <div class="row">
            ...
            <a class="btn btn-primary mb-4 ml-3" href="{{ route('admin.tbp.create') }}">
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <form class="form-inline">
                          ...
                          <a href="{{ route('admin.tbp.index') }}" class="btn btn-outline-danger mb-2"><i class="fa fa-reset"></i> Reset</a>
                        </form>
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('admin.tbp.report', $item->id) }}">PDF</a>
                                        <a class="dropdown-item" href="{{ route('admin.tbp.reportExcel', $item->id) }}">Excel</a>
                                      </div>
                                    </div>
                                    <a href="{{ route('admin.tbp.edit', $item->id) }}" class="btn btn-sm btn-warning btn-edit">
...
<form id="form-delete" action="{{ route('admin.tbp.destroy') }}" class="d-none" method="POST">
  @csrf
  @method('DELETE')
