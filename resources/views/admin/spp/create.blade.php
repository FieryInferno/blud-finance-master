                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="text" class="form-control" name="tanggal_bast" readonly>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <input type="text" class="form-control" name="sisa_spd_total" readonly>
                        </div>
                        <div class="col-md-4">
                          <label>Sisa SPD Kegiatan Pengajuan</label>
                          <input type="text" class="form-control" name="sisa_spd_kegiatan" readonly>
                        </div>
                        <div class="col-md-4">
                          <label>Sisa Kas</label>
                          <input type="text" class="form-control" name="sisa_kas" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="sisa_pagu_pengajuan" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                                  ...
                                  <div class="col-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select name="akun_bendahara" class="form-control" id="rekening-bendahara">
                                        <option>Pilih Rekening Bendahara Bendahara</option>
                                      </select>
                                    </div>
                                    <div class="form-group">
      ...
      $(document).ready(function () {
        ...
        $('#get-modal-spd').click(function () {
          ...
          spd.forEach(function (item) {
            data.push({
              'Nomor SPD': `${item.nomor}<input type="hidden" name="spd_id[]" value="${item.id}">`,
              'Tanggal SPD': `${item.tanggal}`,
          ...
          success : function(response){
            ...
            if (parseInt(response.total_data) > 0){
              ...
              data.rincian.forEach(function (item){
                var nominal = parseFloat(item.harga).toFixed(2) * parseInt(item.unit);
