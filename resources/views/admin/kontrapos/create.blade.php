                                  ...
                                  <table class="table" id="table-kontrapos">
                                    ...
                                    <tbody>
                                      {{-- <tr>
                                        ...
                                        <td>
                                          <input type="text" class="form-control" value="123.4.5.6" readonly>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control" value="Hello" readonly>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control" value="555.555.555" readonly>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control" value="Hey There!" readonly>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control money" value="0">
                                        </td>
                                        <td>
                                          <input type="text" class="form-control money" value="0" readonly>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control" value="BLUD" readonly>
                                        </td>
                                      </tr> --}}
                                    </tbody>
                                  </table>
...
@section('js')
  ...
  <script>
      $(document).ready(function () {        
        ...
        $.ajax({
          type: "POST",
          url: "{{ route('admin.kontrapos.save') }}",
          data: formData,
          beforeSend:function() {
