                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <input type="text" class="form-control" name="nomor" placeholder="(Auto)" value="{{ $jurnalPenyesuaian->nomorfix }}" readonly>
                            </div>
                              ...
                              <select name="unit_kerja" id="unit_kerja" class="form-control" {{ (auth()->user()->hasRole('Puskesmas') ? 'readonly' : '') }}>
                                  ...
                                  @foreach ($unitKerja as $item)
                                      <option value="{{ $item->kode }}"
                                        {{ ($jurnalPenyesuaian->kode_unit_kerja == $item->kode ? 'selected' : '') }}
                  ...
                  <div class="form-group">
                      <div class="row">
                          <div class="col">
                              ...
                              <input type="text" class="form-control" name="keterangan" value="{{ $jurnalPenyesuaian->keterangan }}">
                          </div>
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="basis" id="kas" value="kas" {{ $jurnalPenyesuaian->basis == 'kas' ? 'checked' : '' }}>
                        <label class="form-check-label" for="radio1">
                          Basis Kas
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="basis" value="aktual" {{ $jurnalPenyesuaian->basis == 'aktual' ? 'checked' : '' }}>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <table class="table" id="table-jurnal-penyesuaian">
                                  ...
                                  <tbody>
                                    @foreach ($jurnalPenyesuaian->jurnalPenyesuaianRincian as $item)
                                      <tr>
                                        <td>
                                        ...
                                        value="{{ $item->kegiatan ? $item->kegiatan->kode_program.'.'.$item->kegiatan->kode_bidang.'.'.$item->kegiatan->kode : '' }}" readonly>
                                        <input type="hidden" name="kegiatan_id[]" value="{{ $item->kegiatan ? $item->kegiatan->id : '' }}">
                                        </td>
                                        <td>
                                          <input type="text" name="nama_kegiatan[]" class="form-control" value="{{ $item->kegiatan ? $item->kegiatan->nama_kegiatan : '' }}" readonly>
                                        </td>
                                        <td>
                                          <input type="text" name="debet[]" class="form-control money" value="{{ $item->debet }}">
                                        </td>
                                        <td>
                                          <input type="text" name="kredit[]" class="form-control money" value="{{ $item->kredit }}">
                                        </td>
                                      </tr>
                                    @endforeach
                                    </tbody>
...
@section('js')
  ...
  <script>
      ...
      $(document).ready(function () {
        ...
        $(".date").datepicker('update', '{{ $jurnalPenyesuaian->tanggal }}');
        ...
        $.ajax({
          type: "PUT",
          url: "{{ route('admin.jurnal_penyesuaian.update', $jurnalPenyesuaian->id ) }}",
          data: formData,
          beforeSend:function() {
