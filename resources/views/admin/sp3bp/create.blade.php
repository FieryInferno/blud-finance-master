                            ...
                            <div class="tab-pane active show" id="rincian_pengesahan" role="tabpanel" aria-labelledby="home-tab">
                              <div class="row">
                                <div class="col-md-12 table-responsive">
                                  <table class="table table-striped table-sp3b">
                                    <thead>
                                      <th>Nomor</th>
                                      <th>Kode Kegiatan</th>
                                      <th>Nama Kegiatan</th>
...
@section('js')
  ...
  <script>
      ...
      function getRekeningBendaharaPenerimaan(){
      ...
      function getRekeningBendaharaPengeluaran() {
