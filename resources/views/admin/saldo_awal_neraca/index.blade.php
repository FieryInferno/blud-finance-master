...
<div class="main-content">
  <section class="section">
      <div class="section-header">
          <h1>Saldo Awal Neraca <h1>
      </div>

      <div class="section-body">
          <div class="row">

             <a class="btn btn-primary mb-4 ml-3" href="{{ route('admin.saldo_neraca.create') }}">
                          ...
                          <tbody>
                            @foreach ($saldoAwal as $item)
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{ route('admin.saldo_neraca.edit', $item->id) }}" class="btn btn-sm btn-warning btn-edit">
...
<form id="form-delete" action="{{ route('admin.saldo_neraca.destroy') }}" class="d-none" method="POST">
  @csrf
  @method('DELETE')
