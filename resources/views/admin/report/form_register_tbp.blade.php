...
<body>
    <div class="container">
        ...
        @php
            $totalPindah = 0;
        @endphp
        @foreach ($dataTbp as $groupIndex => $group)
        <table class="content">
            <tr>
                <th class="borderLeft text-center" style="padding: 3px; width: 3%;">No</th>
                <th class="borderLeft text-center" style="padding: 3px; width: 5%;">No TBP</th>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <th class="borderAll text-center">
                        @foreach ($item->rincianTbp as $rincian)
                ...
                @else
                    <tr>
                        ...
                        <td class="text-left borderAll"></td>
                        <td class="text-left borderAll"></td>
                        <td class="text-right borderAll font-weight-bold">{{ format_report($totalTbp) }}</td>
                        <td class="text-left borderAll"></td>
                        <td class="text-left borderAll"></td>
                    </tr>
                @endif
