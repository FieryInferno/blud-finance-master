    ...
    <div class="container" style="border: 1px solid #000000;">
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="borderNone" style="width: 60%;">{{ $sts->rekeningBendahara->nama_bank }}</td>
                    </tr>

                    <tr>
                        <td class="borderNone" style="width: 39%;">No Rekening</td>
                        <td class="borderNone" style="width: 1%;" class="text-right">:</td>
                        <td class="borderNone" style="width: 60%;">{{ $sts->rekeningBendahara->rekening_bank }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="col-print-12">
            <table style="margin-top: 10px;">
                <tbody>
                    <tr>
                        <td class="borderNone" style="width: 20%;">Harapan diterima uang sebesar</td>
                        <td class="borderNone" style="width: 60%;">{{ format_idr($sts->total_nominal) }}</td>
                    </tr>

                    <tr>
                        <td class="borderNone" style="width: 20%;">(dengan huruf)</td>
                        <td class="borderNone" style="width: 60%; font-size: 10px;"><i>( {{ strtoupper(terbilang($sts->total_nominal)) }} )</i></td>
                    </tr>

                    <tr>
                        <td class="borderNone" style="width: 20%;">Keterangan</td>
                        <td class="borderNone" style="width: 60%;"> {{ $sts->keterangan }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
