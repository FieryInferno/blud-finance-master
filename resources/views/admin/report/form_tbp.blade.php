...
<body>
    <div class="header">
        ...
        <div class="col-print-6">
            ...
            <p class="text-center font-weight-bold" style="font-size: 18px;">BLUD {{ strtoupper($tbp->unitKerja->nama_unit) }}</p>
        </div>
    ...
    <div class="content">
        <div class="col-print-12">
            <table style="margin-top: 10px;">
                <tbody>
                    <tr>
                        <td class="borderNone" style="width: 20%;">NO. KWITANSI</td>
                        <td class="borderNone" style="width: 60%;">: {{ $tbp->nomorfix }}</td>
                    </tr>

                    <tr>
                        <td class="borderNone" style="width: 20%;">Telah Terima dari</td>
                        <td class="borderNone" style="width: 60%;">: Pasien</td>
                    </tr>

                    <tr>
                        <td class="borderNone" style="width: 20%;">Untuk Pembayaran</td>
            ...
            <table style="margin-top: 10px;">
                <tbody>
                    <tr>
                        <td class="borderNone" style="width: 20%;">Sejumlah</td>
                        <td class="borderNone" style="width: 60%;">: {{ format_idr($tbp->total_nominal) }}</td>
                    </tr>

                    <tr>
                        <td class="borderNone" style="width: 20%;">Terbilang</td>
                        <td class="borderNone" style="width: 60%;">: {{ strtoupper(terbilang($tbp->total_nominal)) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
