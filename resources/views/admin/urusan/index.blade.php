  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Buat Urusan</h5>
      ...
      <form action="{{ route('admin.urusan.store') }}" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama_urusan" class="form-control" value="{{ old('nama_urusan') }}" required>
            </div>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Sunting Urusan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('admin.urusan.update') }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label>Nama Urusan</label>
              <input type="text" id="edit-nama" name="nama_urusan" class="form-control" value="" required>
            </div>
        </div>
        <div class="modal-footer bg-whitesmoke br">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
...
{{-- form delete --}}
<form id="form-delete" action="{{ route('admin.urusan.destroy') }}" class="d-none" method="POST">
  @csrf
  @method('DELETE')
